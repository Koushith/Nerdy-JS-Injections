      ...
      while (allConnections.length < limit) {
        ...
        const response = await fetch(url, {
          "headers": {
            ...
            "x-li-track": "{\"clientVersion\":\"1.13.22711\",\"mpVersion\":\"1.13.22711\",\"osName\":\"web\",\"timezoneOffset\":5.5,\"timezone\":\"Asia/Calcutta\",\"deviceFormFactor\":\"DESKTOP\",\"mpName\":\"voyager-web\",\"displayDensity\":2,\"displayWidth\":1618,\"displayHeight\":1580}",
        ...
        const connections = json.included
          ...
          .map(item => ({
            ...
            url: "https://linkedin.com/in/" + item.publicIdentifier,
             pfp: item.profilePicture?.displayImageReference?.vectorImage?.rootUrl +item.profilePicture?.displayImageReference?.vectorImage?.artifacts[2]?.fileIdentifyingUrlPathSegment
